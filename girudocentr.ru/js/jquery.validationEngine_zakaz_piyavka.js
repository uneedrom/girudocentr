...
(function($) {
	...
	if($.validationEngineLanguage){				// IS THERE A LANGUAGE LOCALISATION ?
		...
		allRules = 	{"required":{    			// Add your regex rules here, you can take telephone as an example
						"regex":"none",
						"alertText":"* Поле должно быть заполнено",
					...
					"ajaxName":{
						...
						"alertTextOk":"* Этот никнейм свободен",	
						"alertTextLoad":"* Загрузка, ждите...",
						"alertText":"* Такой никнейм занят"},
					"ajaxCaptcha":{
						"file":"/validateCaptcha.php",	
						"alertTextLoad":"* Загрузка, ждите...",
						"alertText":"* Неправильный код"},
					"onlyLetter":{
						"regex":"/^[0-9a-zA-Z]+$/",
